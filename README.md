...
```javascript
FLOAT16_MAX_SAFE_INTEGER = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-max-safe-integer@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-max-safe-integer@v0.1.1-umd/browser.js"></script>
```
